...
namespace AFeiDemo.DAL
{
    public class UserRoleDAL:IUserRoleDAL
    {
        ...
        public bool SetRoleBatch(List<UserRoleModel> role_addList, List<UserRoleModel> role_deleteList)
        {
        ...
        /// <param name="role_addList">要增加的</param>
        /// <param name="role_deleteList">要删除的</param>
        public bool SetRoleSingle(List<UserRoleModel> role_addList, List<UserRoleModel> role_deleteList)
        {
